...
public class WltStockOutController {
    ...
    public WltStockOutResponse execute(@RequestBody WltStockOutRequest request) throws Exception {
        ...
        } else if(WltStockOutRequest.ACTION_WLT_SHIP_BY_ORDER.equals(actionType)){
            gcService.wltOtherShipByOrder(requestBody.getDocumentLine(), requestBody.getMaterialLotActions(), requestBody.getSubCode());
        } else {
