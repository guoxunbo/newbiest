...
public class GcGetMLotCodePrintParaController extends AbstractRestController {
    ...
    @ApiOperation(value = "获取箱/真空包物料编码标签参数，并进行打印")
    @ApiImplicitParam(name="request", value="request", required = true, dataType = "GcPrintMLotCodeLabelRequest")
    ...
    public GcGetMLotCodePrintParaResponse execute(@RequestBody GcGetMLotCodePrintParaRequest request) throws Exception {
        ...
        gcService.printMaterialCodeLabel(requestBody.getMaterialLot(), requestBody.getPrintType());
