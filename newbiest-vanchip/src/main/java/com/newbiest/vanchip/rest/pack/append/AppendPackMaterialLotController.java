 ...
 * 物料批次追加包装
 */
@RestController("VCAppendPackMaterialLotController")
@RequestMapping("/vc")
@Slf4j
...
public class AppendPackMaterialLotController extends AbstractRestController {
    ...
    public AppendPackMaterialLotResponse execute(@RequestBody AppendPackMaterialLotRequest request) throws Exception {
        ...
        MaterialLot appendMaterialLot = vanChipService.appendPacking(requestBody.getPackedMaterialLot(), requestBody.getWaitToAppendActions());
