...
CREATE TABLE `NB_USER` (
  ...
  UNIQUE KEY `org_rrn` (`org_rrn`,`username`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='User Info';

-- ----------------------------
-- Records of NB_USER
-- ----------------------------
INSERT INTO `NB_USER` VALUES (1, 'Y', 0, '2018-06-06 22:17:22', NULL, '2018-12-29 13:54:14', NULL, 242, 'admin', '管理员', 'c4ca4238a0b923820dcc509a6f75849b', '2018-12-25 12:02:04', NULL, NULL, 0, NULL, NULL, NULL, '11603652@qq.com', 'Y', '2018-12-29 13:54:14');
INSERT INTO `NB_USER` VALUES (2, 'Y', 1, '2018-12-25 11:11:40', NULL, '2018-12-29 10:52:00', NULL, 14, 'test', '测试用户', 'c4ca4238a0b923820dcc509a6f75849b', '2018-12-25 12:01:29', '2019-10-21 12:01:29', 300, 0, '', NULL, NULL, '116036512@qq.com', 'Y', '2018-12-29 10:52:00');
COMMIT;
