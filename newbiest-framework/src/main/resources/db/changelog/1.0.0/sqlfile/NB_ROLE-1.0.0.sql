...
CREATE TABLE `NB_ROLE` (
  ...
  UNIQUE KEY `org_rrn` (`org_rrn`,`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Role Info';

-- ----------------------------
-- Records of NB_ROLE
-- ----------------------------
INSERT INTO `NB_ROLE` VALUES (5, 'Y', 1, '2018-12-26 13:18:12', NULL, '2018-12-29 14:34:55', NULL, 242, 'TestRole', '测试角色');
COMMIT;
