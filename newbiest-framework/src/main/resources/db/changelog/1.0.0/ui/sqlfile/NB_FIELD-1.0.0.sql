...
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='field Info';

-- ----------------------------
-- Records of NB_FIELD
-- ----------------------------
INSERT INTO `NB_FIELD` VALUES (1, 'Y', 0, 'name', '名称', 'NAME', 2, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'Y', NULL, NULL, 'N', 'Name', '名称', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (2, 'Y', 0, 'description', '描述', 'DESCRIPTION', 2, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (3, 'Y', 0, 'modelClass', '对象全名', 'MODEL_CLASS', 2, 1, 40, 'text', NULL, NULL, NULL, NULL, NULL, NULL, '', 'Y', 'N', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'ModelClass', '对象全名', NULL, NULL, 300, 'N');
INSERT INTO `NB_FIELD` VALUES (4, 'Y', 0, 'tableName', '表名', 'TABLE_NAME', 2, 1, 30, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, 'Y', NULL, NULL, '', NULL, NULL, 'Y', 'TableName', '表名', NULL, NULL, 150, 'N');
...
INSERT INTO `NB_FIELD` VALUES (6, 'Y', 0, 'whereClause', '查询条件', 'WHERE_CLAUSE', 2, 1, 50, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'WhereClause', '查询条件', NULL, NULL, 200, 'N');
INSERT INTO `NB_FIELD` VALUES (7, 'Y', 0, 'initWhereClause', '初始化查询条件', 'INIT_WHERE_CLAUSE', 2, 1, 60, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'InitWhereClause', '初始化查询条件', NULL, NULL, 200, 'N');
INSERT INTO `NB_FIELD` VALUES (8, 'Y', 0, 'orderBy', '排序', 'ORDER_BY', 2, 1, 70, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'OrderBy', '排序条件', NULL, NULL, 200, 'N');
INSERT INTO `NB_FIELD` VALUES (9, 'Y', 0, 'modelName', '类名', 'MODEL_NAME', 2, 1, 35, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'ModelName', '类名', NULL, NULL, 200, 'N');
...
INSERT INTO `NB_FIELD` VALUES (11, 'Y', 0, 'description', '描述', 'DESCRIPTION', 66, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', NULL, 'Y', NULL, NULL, '', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, 100, 'N');
...
INSERT INTO `NB_FIELD` VALUES (16, 'Y', 0, 'defaultValue', '默认值', 'DEFAULT_VALUE', 66, 6, 190, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'N', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'Default', '默认值', NULL, NULL, NULL, 'N');
...
INSERT INTO `NB_FIELD` VALUES (18, 'Y', 0, 'labelZh', '中文', 'LABEL_ZH', 66, 6, 200, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', '', 'Y', 'Y', NULL, 'Y', NULL, NULL, '', NULL, NULL, 'Y', 'Chinese', '中文', NULL, NULL, 100, 'N');
INSERT INTO `NB_FIELD` VALUES (19, 'Y', 0, 'displayType', '显示类型', 'DISPLAY_TYPE', 66, 6, 52, 'sysRefList', NULL, NULL, NULL, NULL, 'FieldDisplayType', NULL, NULL, 'Y', '', 'Y', 'Y', NULL, 'Y', NULL, NULL, '', NULL, NULL, 'Y', 'DisplayType', '显示类型', NULL, NULL, 100, 'N');
...
INSERT INTO `NB_FIELD` VALUES (35, 'Y', 0, 'name', '名称', 'NAME', 65, NULL, 10, 'text', NULL, NULL, NULL, NULL, '', NULL, '', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'Y', NULL, NULL, 'N', 'name', '名称', NULL, '', 100, 'N');
INSERT INTO `NB_FIELD` VALUES (36, 'Y', 1, 'description', '描述', 'DESCRIPTION', 65, NULL, 20, 'text', NULL, NULL, NULL, NULL, '', NULL, '', 'Y', 'Y', 'Y', 'Y', 'N', NULL, 'N', NULL, 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, '', 150, 'N');
...
INSERT INTO `NB_FIELD` VALUES (38, 'Y', 1, 'seqNo', '序号', 'SEQ_NO', 65, NULL, 40, 'int', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', NULL, 'Y', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'seqNo', '序号', NULL, NULL, 100, NULL);
...
INSERT INTO `NB_FIELD` VALUES (40, 'Y', 0, 'label', '英文', 'LABEL', 65, 8, 70, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'Label', '英文', NULL, NULL, 100, 'N');
INSERT INTO `NB_FIELD` VALUES (41, 'Y', 0, 'labelZh', '中文', 'LABEL_ZH', 65, 8, 90, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'LabelZh', '中文', NULL, NULL, 100, 'N');
INSERT INTO `NB_FIELD` VALUES (42, 'Y', 0, 'name', '名称', 'NAME', 67, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'Y', NULL, NULL, 'N', 'name', '名称', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (43, 'Y', 0, 'description', '描述', 'DESCRIPTION', 67, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (44, 'Y', 0, 'refTableName', '参考表', 'REF_TABLE_NAME', 65, 8, 50, 'referenceTable', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'RefTable', '动态表', NULL, 'NBTableByName', NULL, 'N');
...
INSERT INTO `NB_FIELD` VALUES (46, 'Y', 1, 'objectRrn', '主键', 'OBJECT_RRN', 65, NULL, 1, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'N', 'N', 'N', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'N', 'ObjectRrn', '主键', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (47, 'Y', 1, 'name', '名称', 'NAME', 68, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'Y', NULL, NULL, 'Y', 'Name', '名称', NULL, NULL, 150, 'N');
INSERT INTO `NB_FIELD` VALUES (48, 'Y', 1, 'description', '描述', 'DESCRIPTION', 68, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, 200, 'N');
...
INSERT INTO `NB_FIELD` VALUES (50, 'Y', 1, 'keyField', '关键字栏位', 'KEY_FIELD', 68, NULL, 40, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'Key', '关键字栏位', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (51, 'Y', 1, 'textField', '显示栏位', 'TEXT_FIELD', 68, NULL, 50, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'Text', '显示栏位', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (52, 'Y', 1, 'whereClause', '条件语句', 'WHERE_CLAUSE', 68, NULL, 70, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'WhereClause', '条件语句', NULL, NULL, 300, 'N');
INSERT INTO `NB_FIELD` VALUES (53, 'Y', 1, 'orderBy', '排序', 'ORDER_BY', 68, NULL, 80, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'OrderBy', '排序', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (54, 'Y', 1, 'key', '关键字', 'KEY', 69, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'Key', '关键字', NULL, NULL, 150, 'N');
INSERT INTO `NB_FIELD` VALUES (55, 'Y', 1, 'description', '描述', 'DESCRIPTION', 69, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, 300, 'N');
INSERT INTO `NB_FIELD` VALUES (56, 'Y', 1, 'value', '显示信息', 'VALUE', 69, NULL, 30, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', NULL, 'N', NULL, NULL, 'Y', 'value', '显示信息', NULL, NULL, 300, 'N');
...
INSERT INTO `NB_FIELD` VALUES (60, 'Y', 1, 'fromParent', '来源于父值', 'FROM_PARENT', 66, 4, 90, 'radio', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'N', 'Y', 'N', 'N', 'N', NULL, 'N', NULL, NULL, 'Y', 'FromParent', '来源于父值', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (61, 'Y', 1, 'referenceRule', '参考规则', 'REFERENCE_RULE', 66, 4, 100, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'N', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'RefRule', '参考规则', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (62, 'Y', 1, 'name', '名称', 'NAME', 70, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'Y', NULL, NULL, 'Y', 'name', '名称', NULL, NULL, NULL, 'N');
INSERT INTO `NB_FIELD` VALUES (63, 'Y', 1, 'description', '描述', 'DESCRIPTION', 70, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, NULL, 'N');
...
INSERT INTO `NB_FIELD` VALUES (65, 'Y', 1, 'key', '关键字', 'KEY', 71, NULL, 10, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'N', NULL, NULL, 'Y', 'Key', '关键字', NULL, NULL, 150, 'N');
INSERT INTO `NB_FIELD` VALUES (66, 'Y', 1, 'description', '描述', 'DESCRIPTION', 71, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, 300, 'N');
INSERT INTO `NB_FIELD` VALUES (67, 'Y', 1, 'value', '显示值', 'VALUE', 71, NULL, 40, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'N', NULL, NULL, 'Y', 'Value', '显示值', NULL, NULL, 300, 'N');
...
INSERT INTO `NB_FIELD` VALUES (70, 'Y', 1, 'description', '描述', 'DESCRIPTION', 72, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, 200, 'N');
...
INSERT INTO `NB_FIELD` VALUES (78, 'Y', 0, 'pwdWrongCount', '密码错误次数', 'PWD_WRONG_COUNT', 72, 12, 90, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'N', 'N', 'Y', 'Y', 'N', 'N', 'N', 'N', NULL, NULL, 'N', 'PwdWrongCount', '密码错误次数', NULL, NULL, NULL, 'N');
...
INSERT INTO `NB_FIELD` VALUES (81, 'Y', 1, 'message', '英文', 'MESSAGE', 73, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'Message', '英文', NULL, NULL, 300, 'N');
...
INSERT INTO `NB_FIELD` VALUES (84, 'Y', 1, 'description', '描述', 'DESCRIPTION', 74, NULL, 20, 'text', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', NULL, NULL, 'Y', 'Desc', '描述', NULL, NULL, NULL, 'N');
COMMIT;
