...
public class NewbiestException {
    ...
    public static final String COMMON_WRONG_PWD_MORE_THAN_COUNT = "common.wrong_pwd_more_than_count";
    public static final String COMMON_USER_PASSWORD_IS_INCORRECT = "common.user_pwd_is_incorrect";
