...
public class WorkflowUtils {
    ...
    private static final String EXCLUSIVE_GATEWAY_ID = "ExclusiveGateway";


    private static final String START_EVENT_NAME = "com.wf_start_event_name";
    private static final String END_EVENT_NAME = "com.wf_end_event_name";

    private static final String EXCLUSIVE_GATEWAY_NAME = "com.wf_if_node_name";
     ...
     * @return
     */
    public SequenceFlow generateSequenceFlowWithSkipCondition(String sourceEventId, String targetEventId, String skipCondition) {
     ...
     * @return
     */
    public SequenceFlow generateSequenceFlowWithCondition(String sourceEventId, String targetEventId, String conditionExpression) {
        SequenceFlow sequenceFlow = generateSequenceFlow(sourceEventId, targetEventId);
        if (!StringUtils.isNullOrEmpty(conditionExpression)) {
            sequenceFlow.setSkipExpression(conditionExpression);
        }
     ...
     * @return
     */
    public ExclusiveGateway generateExclusiveGateway() {
