...
public class MaterialLotHistory extends NBHis {
    ...
    public static final String TRANS_TYPE_STOCK_OUT_TAG_UPDATE = "StockOutTagUpdate";
    ...
    public static final String TRANS_TYPE_MES_RETURN_DELETE = "MesReruenDelete";
    public static final String TRANS_TYPE_MES_RETURN_MATERIAL = "MesReruenMaterial";
    ...
    public static final String TRANS_TYPE_AUTO_CREATE_ONE = "AUTO_CREATE";
